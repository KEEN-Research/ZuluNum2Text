...
public interface NumberVerbaliser {
    ...
    String getText(int number, NumCategory category, boolean debugMode, boolean firstFuncCall) throws Exception;
    String getText(int number, NounClass nounClass, NumCategory category, boolean debugMode, boolean firstFunctionCall) throws Exception;
}
